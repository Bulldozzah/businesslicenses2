...
class RegulationFieldType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('fieldchoices', 'collection', array(
                'type' => new RegulationFieldChoiceType(),
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'OTB\Bundle\NoticeAndCommentBundle\Entity\RegulationField'
        ));
    }
    ...
    {
        return 'regulation_custom_fields';
    }
}
