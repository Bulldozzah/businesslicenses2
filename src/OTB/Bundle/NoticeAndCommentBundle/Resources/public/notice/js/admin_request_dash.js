...
function getDashStatistics_1() {
    let statistics = $.ajax({ url: '/index.php/admin/dashboard-starts_1', type: 'get', data: {}, datatype: 'JSON' });
    statistics.done(function (response) {
        response = JSON.parse(response);
        $("#industries").html(response.webStats.industries);
        $("#createdindustries").html(response.webStats.createdindustries);
        $("#removedindustries").html(response.webStats.removedindustries);
    });
}
function getDashStatistics_2() {
    let statistics = $.ajax({ url: '/index.php/admin/dashboard-starts_2', type: 'get', data: {}, datatype: 'JSON' });
    statistics.done(function (response) {
        response = JSON.parse(response);
...
function getDashStatistics_3() {
    let statistics = $.ajax({ url: '/index.php/admin/dashboard-starts_3', type: 'get', data: {}, datatype: 'JSON' });
    statistics.done(function (response) {
        response = JSON.parse(response);
...
function getDashStatistics_4() {
    let statistics = $.ajax({ url: '/index.php/admin/dashboard-starts_4', type: 'get', data: {}, datatype: 'JSON' });
    statistics.done(function (response) {
        response = JSON.parse(response);
...
function getDashStatistics_5() {
    let statistics = $.ajax({ url: '/index.php/admin/dashboard-starts_5', type: 'get', data: {}, datatype: 'JSON' });
    statistics.done(function (response) {
        response = JSON.parse(response);
...
function getDashStatistics_6() {
    let statistics = $.ajax({ url: '/index.php/admin/dashboard-starts_6', type: 'get', data: {}, datatype: 'JSON' });
    statistics.done(function (response) {
        response = JSON.parse(response);
...
function getDashStatistics_7() {
    let statistics = $.ajax({ url: '/index.php/admin/dashboard-starts_7', type: 'get', data: {}, datatype: 'JSON' });
    statistics.done(function (response) {
        response = JSON.parse(response);
...
function getDashStatistics_8() {
    let statistics = $.ajax({ url: '/index.php/admin/dashboard-starts_8', type: 'get', data: {}, datatype: 'JSON' });
    statistics.done(function (response) {
        response = JSON.parse(response);
...
function getDashStatistics_9() {
    let statistics = $.ajax({ url: '/index.php/admin/dashboard-starts_9', type: 'get', data: {}, datatype: 'JSON' });
    statistics.done(function (response) {
        response = JSON.parse(response);
...
function getDashStatistics_10() {
    let statistics = $.ajax({ url: '/index.php/admin/dashboard-starts_10', type: 'get', data: {}, datatype: 'JSON' });
    statistics.done(function (response) {
        response = JSON.parse(response);
...
function getDashStatistics_11() {
    let statistics = $.ajax({ url: '/index.php/admin/dashboard-starts_11', type: 'get', data: {}, datatype: 'JSON' });
    statistics.done(function (response) {
        response = JSON.parse(response);
