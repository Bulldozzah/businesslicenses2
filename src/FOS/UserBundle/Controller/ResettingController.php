...
class ResettingController extends ContainerAware
{
    ...
    public function checkEmailAction(Request $request)
    {
        ...
        error_log("Debug: Default send email action");
        if (empty($email)) {
            error_log("Debug:::: the user does not come from the sendEmail action");
        ...
        if ('POST' === $request->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                if (null === $response = $event->getResponse()) {
                    $url = $this->container->get('router')->generate('homepage_notice_comments');
