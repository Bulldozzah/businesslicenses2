...
================================================== */
	...
	$("#webmastersafrica_pressbundle_page_page_content").cleditor({
		width:"100%",
		height:"100%",
		bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
	});

	$("#webmastersafrica_pressbundle_news_article").cleditor({
		width:"100%",
		height:"100%",
		bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
	});

	$("#webmastersafrica_pressbundle_newsletter_content").cleditor({
		width:"100%",
		height:"100%",
		bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
	});
