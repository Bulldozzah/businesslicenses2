$(function() {
    ...
    $.mask.definitions['~'] = "[+-]";
    $("#webmastersafrica_taskbundle_task_taskStartDate").mask("99/99/9999",{completed:function(){alert("Callback when completed");}});
    $("#webmastersafrica_taskbundle_task_taskEndDate").mask("99/99/9999",{completed:function(){alert("Callback when completed");}});
    ...
    if ($('#webmastersafrica_pressbundle_page_page_content').length){
        CKEDITOR.replace("webmastersafrica_pressbundle_page_page_content");
    }

    if ($('#webmastersafrica_pressbundle_news_article').length){
        CKEDITOR.replace("webmastersafrica_pressbundle_news_article");
    }
    ...
    if ($('#webmastersafrica_pressbundle_newsletter_content').length){
        CKEDITOR.replace("webmastersafrica_pressbundle_newsletter_content");
    }
    ...
    $("#webmastersafrica_licensebundle_businesslicense_purpose").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_comments").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_application_fee").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_license_fee").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_related_websites").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_contact_office").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_resolution_criteria").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_0_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_1_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_2_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_3_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_4_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_5_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_6_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_7_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_8_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_9_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_10_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_11_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_12_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_13_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_14_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_15_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_16_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_17_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_18_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_19_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });

    $("#webmastersafrica_licensebundle_businesslicense_requirements_20_description").cleditor({
        width:"100%",
        height:"100%",
        bodyStyle: "margin: 10px; font: 12px Arial,Verdana; cursor:text"
    });
    ...
    $('.de').click(function () {
        $('.localeDropdown').slideToggle(200);
    });
    $(document).bind('click', function(e) {
        var $clicked = $(e.target);
        if (! $clicked.parents().hasClass("de"))
            $(".localeDropdown").slideUp(200);
    });
...
//===== Progress bars =====//
    ...
    $("input:file").each(function(){
        var $input = $(this), 
            text = $input.parent().data('file-name');
        $input.uniform({
            fileDefaultText: undefined === text ? 'No file selected': text
        });
    });
