...
class FaqController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $pagination = $em->getRepository(Faq::class)->findBy(['deleted' => 0, 'site' => 2], ['orderLevel' => 'ASC', 'published' => 'DESC']);

        return $this->render('WebmastersAfricaPressBundle:Faq:index.html.twig', array(
    ...
    public function batchAction(Request $request)
    {
        ...
        return $this->redirect($this->generateUrl('managefaq'));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('WebmastersAfricaPressBundle:Faq:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Faq $entity)
    {
        $form = $this->createForm(new FaqType(), $entity, array(
            'action' => $this->generateUrl('managefaq_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        return $this->render('WebmastersAfricaPressBundle:Faq:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('WebmastersAfricaPressBundle:Faq:edit.html.twig', array(
            'entity'      => $entity,
    ...
    {
        $form = $this->createForm(new FaqType(), $entity, array(
            'action' => $this->generateUrl('managefaq_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('managefaq_delete', array('id' => $id)))
            ->setMethod('DELETE')
