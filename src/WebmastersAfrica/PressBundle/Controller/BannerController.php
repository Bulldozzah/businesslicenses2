...
use WebmastersAfrica\PressBundle\Form\BannerType;
...
class BannerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $dql   = "SELECT a FROM WebmastersAfricaPressBundle:Banner a";
        ...
        return $this->render('WebmastersAfricaPressBundle:Banner:index.html.twig', array(
    ...
    public function batchAction(Request $request)
    {
        ...
        foreach ($batch_items as $batch_item) {
            if ($batch_select == "delete") {
                $entity = $em->getRepository('WebmastersAfricaPressBundle:Banner')->find($batch_item);
                $em->remove($entity);
        ...
        return $this->redirect($this->generateUrl('managebanners'));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('WebmastersAfricaPressBundle:Banner:new.html.twig', array(
            'entity' => $entity,
    ...
    private function createCreateForm(Banner $entity)
    {
        $form = $this->createForm(new BannerType(), $entity, array(
            'action' => $this->generateUrl('managebanners_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WebmastersAfricaPressBundle:Banner')->find($id);
        ...
        return $this->render('WebmastersAfricaPressBundle:Banner:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('WebmastersAfricaPressBundle:Banner:edit.html.twig', array(
            'entity'      => $entity,
    ...
    {
        $form = $this->createForm(new BannerType(), $entity, array(
            'action' => $this->generateUrl('managebanners_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        return $this->render(
            'WebmastersAfricaPressBundle:Banner:edit.html.twig',
            array(
                'entity'      => $entity,
                'edit_form'   => $editForm->createView(),
                'delete_form' => $deleteForm->createView(),
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('managebanners_delete', array('id' => $id)))
            ->setMethod('DELETE')
