...
/**
 * WebmastersAfrica\PressBundle\Entity\Newsletter
 *
 * @ORM\Table(name="newsletter")
 * @ORM\Entity
 */
class Newsletter implements Translatable
{
    /**
     * @var integer $id
     *
     ...
     * @Gedmo\Timestampable(on="change", field={"subject", "content", "sent", "deleted"})
     */
