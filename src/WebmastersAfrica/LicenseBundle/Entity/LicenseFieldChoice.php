...
/**
 * WebmastersAfrica\LicenseBundle\Entity\LicenseFieldChoice
 *
 * @ORM\Table(name="licensefieldchoice")
 * @ORM\Entity
 */
class LicenseFieldChoice implements Translatable
{
    /**
     * @var integer $id
     *
    ...
    private $field_id;
     ...
     /**
     * @ORM\ManyToOne(targetEntity="LicenseField", inversedBy="fieldchoices",cascade={"persist"})
