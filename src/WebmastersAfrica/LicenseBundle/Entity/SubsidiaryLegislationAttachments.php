...
/**
 * WebmastersAfrica\LicenseBundle\Entity\SubsidiaryLegislationAttachments
 *
 * @ORM\Table(name="subsidiary_legislation_attachments")
 * @ORM\Entity
 */
class SubsidiaryLegislationAttachments implements Translatable
{
    /**
     * @var integer $id
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="BusinessLicense", inversedBy="subsidiary_legislation")
     * @ORM\JoinColumn(name="business_license_id", referencedColumnName="id")
     */
     ...
     */
    public function setBusinessLicense(BusinessLicense $businessLicense = null)
    {
