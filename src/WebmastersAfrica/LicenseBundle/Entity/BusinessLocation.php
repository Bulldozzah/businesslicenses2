 ...
 * @ORM\Entity(repositoryClass="WebmastersAfrica\LicenseBundle\Entity\BusinessLocationRepository")
 * @UniqueEntity("name")
 */
class BusinessLocation implements Translatable
{
    /**
     * @var integer $id
     *
     ...
     *      min = 2,
     *      max = 250,
     *      minMessage = "Your jurisdiction title must be at least {{ limit }} characters long",
     *      maxMessage = "Your jurisdiction title cannot be longer than {{ limit }} characters"
     * )
     */
    private $name;
     ...
     * @Assert\NotBlank(message="Parent Location can't be blank")
     * @ORM\ManyToOne(targetEntity="BusinessLocationCategory", inversedBy="location")
    ...
    public function setParentLocation(BusinessLocationCategory $parentLocation)
    {
