<?php
// src/WebmastersAfrica/UserBundle/Entity/Group.php
...
/**
 * GROUPS is a reserved word since MySQL 8.0.2, so the table name is quoted.
 * @ORM\Entity
...
class Group extends BaseGroup
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="WebmastersAfrica\LicenseBundle\Entity\Workflow", mappedBy="accessGroups")
     */
    private $workflow;
     ...
     * @Gedmo\Timestampable(on="change", field={"name","roles","users"})
     */
     ...
     * @return Group
     */
    public function addUser(\WebmastersAfrica\UserBundle\Entity\User $users)
    {
        $this->users[] = $users;
     ...
     * @param \WebmastersAfrica\UserBundle\Entity\User $users
     */
    public function removeUser(\WebmastersAfrica\UserBundle\Entity\User $users)
    {
