...
$(document).ready(function () {
  ...
  var dashStatistics_1 = setInterval(getDashStatistics_1, 500010);
...
function getDashStatistics_1() {
  let statistics = $.ajax({ url: '/index.php/dash/stats', type: 'get', data: {}, datatype: 'JSON' });
  statistics.done(function (response) {
    response = JSON.parse(response);
    $("#jurisdiction_count").html(response.locations);
    $("#industries").html(response.industries);
  });
}
