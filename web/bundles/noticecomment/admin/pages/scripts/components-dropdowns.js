var ComponentsDropdowns = (function() {
  var handleSelect2 = function() {
    ...
    $("#otb_noticeandcommentbundle_regulation_tags").select2({
      tags: ["red", "green", "blue", "yellow", "pink"]
    });

    $("#otb_noticeandcommentbundle_regulation_keywords").select2({
      tags: ["red", "green", "blue", "yellow", "pink"]
    });
    ...
    function movieFormatResult(movie) {
      ...
      if (
        movie.posters !== undefined &&
        movie.posters.thumbnail !== undefined
      ) {
        markup +=
          "<td valign='top'><img src='" + movie.posters.thumbnail + "'/></td>";
      }
      markup += "<td valign='top'><h5>" + movie.title + "</h5>";
      if (movie.critics_consensus !== undefined) {
        markup +=
          "<div class='movie-synopsis'>" + movie.critics_consensus + "</div>";
