$(function() {
    ...
    CKEDITOR.replace('webmastersafrica_licensebundle_businesslicense_requirements');
    // ClassicEditor
    //     .create( document.querySelector( '#webmastersafrica_licensebundle_businesslicense_requirements' ) )
    //     .catch( error => {
    //         console.error( error );
    //     } );
    // ClassicEditor
    //     .create( document.querySelector( '#webmastersafrica_licensebundle_businesslicense_purpose' ) )
    //     .catch( error => {
    //         console.error( error );
    //     } );
    // ClassicEditor
    //     .create( document.querySelector( '#webmastersafrica_licensebundle_businesslicense_description' ) )
    //     .catch( error => {
    //         console.error( error );
    //     } );
    // ClassicEditor
    //     .create( document.querySelector( '#webmastersafrica_licensebundle_businesslicense_comments' ) )
    //     .catch( error => {
    //         console.error( error );
    //     } );
    // ClassicEditor
    //     .create( document.querySelector( '#webmastersafrica_licensebundle_businesslicense_application_fee' ) )
    //     .catch( error => {
    //         console.error( error );
    //     } );
    // ClassicEditor
    //     .create( document.querySelector( '#webmastersafrica_licensebundle_businesslicense_related_websites' ) )
    //     .catch( error => {
    //         console.error( error );
    //     } );
    // ClassicEditor
    //     .create( document.querySelector( '#webmastersafrica_licensebundle_businesslicense_contact_office' ) )
    //     .catch( error => {
    //         console.error( error );
    //     } );
    // ClassicEditor
    //     .create( document.querySelector( '#webmastersafrica_licensebundle_businesslicense_resolution_criteria' ) )
    //     .catch( error => {
    //         console.error( error );
    //     } );
