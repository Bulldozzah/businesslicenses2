function FormCollection(div_id)
{
    ...
    self.construct = function () {
        ...
        $("#js-new-choice").on('click', function(e) {
    ...
    self.addDeleteLink = function (row) {
        var $removeFormA = $('<a href="#" style="margin-left: 1%;" class="w3-button w3-red w3-tiny w3-left w3-hover-red remove-tag"><i class="fa fa-trash"></i></a>');
