        ...
        initIntro: function () {
            ...
            if (!$.cookie('intro_show')) {
                ...
                setTimeout(function () {
                    var unique_id = $.gritter.add({
                        // (string | mandatory) the heading of the notification
                        title: '<a href="http://themeforest.net/item/metronic-responsive-admin-dashboard-template/4021469?ref=keenthemes" target="_blank">Develop with Metronicssssssssssssssss!</a>',
                        // (string | mandatory) the text inside the notification
