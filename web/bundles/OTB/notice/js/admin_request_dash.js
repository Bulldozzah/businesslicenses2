...
function getDashStatistics_1() {
    ...
    statistics.done(function (response) {
        ...
        $("#industries_count").html(response.webStats.industries);
...
function getDashStatistics_7() {
    ...
    statistics.done(function (response) {
        ...
        $("#newsletters_count").html(response.webStats.newsletters);
...
function getDashStatistics_10() {
    ...
    statistics.done(function (response) {
        ...
        $("#activities_count").html(response.webStats.activities);
...
function getClosedRegulations() {
    var statistics = $.ajax({ url: '/consultation/regulations/close', type: 'get', data: {}, datatype: 'JSON' });
    statistics.done(function (response) {
        response = JSON.parse(response);
